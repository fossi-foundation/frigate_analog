...
S {}
E {}
T {Testbench for Frigate power-up
This is a basic test for default conditions
See cace/ directory for tests over corners and conditions} -270 -370 0 0 0.4 0.4 {}
T {Test #2:  Check power-on sequence with 1.8V supply coming up
after the 3.3V supply.} -670 -240 0 0 0.4 0.4 {}
T {Original test raised vccd0 at 100ms.
This is unnecessary as the circuit is
inactive from about 4ms.} -670 -160 0 0 0.4 0.4 {}
N 280 10 440 10 {
lab=vss}
N 440 10 440 150 {
lab=vss}
...
C {devices/vsource.sym} 760 10 0 0 {name=VVDDIO value="DC 3.3 PWL(0 0 1u 0 100u \{vvddio\})" savecurrent=false}
C {devices/vsource.sym} 620 70 0 0 {name=VVDDA value="DC 3.3 PWL(0 0 1u 0 100u \{vvddio\})" savecurrent=false}
C {devices/vsource.sym} 480 120 0 0 {name=VVCCD value="DC 1.8 PWL(0 0 6m 0 10m \{vvccd\})" savecurrent=false}
...
C {devices/code_shown.sym} -690 200 0 0 {name=s1 only_toplevel=false value="* Frigate power-up test
